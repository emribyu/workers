(async () => {
  ...
  .then(async (res) => {
    ...
    let head = `<meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/><meta name="robots" content="index, follow"/><meta name="googlebot-news" content="index, follow"/><meta name="googlebot" content="index, follow"/><link rel="canonical" href="${loc.href}"/><link rel="shorcut icon" href="https://cdn-limit.wasmer.app/icons/rocket.ico"/><link rel="dns-prefetch" as="script" href="https://cdn.jsdelivr.net"/><link rel="preconnect" as="script" href="https://cdn.jsdelivr.net"/>`,
        body = '';
    ...
    await dom.querySelectorAll('a').forEach((e) => {
      ...
      if(isUrl(href)) {
        href = loc.origin + '/blog.html?read=' + encodeURIComponent(encodeURIComponent(href));
      }
      e.href = href;
    });

    try {
      let ihref = dom.querySelectorAll('a');
      ihref[Math.floor(Math.random() * ihref.length)].href = '/';
    } catch {}
